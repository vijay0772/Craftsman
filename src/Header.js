...
function Header() {
  ...
  <header className="App-header">
    <div className="header-content">
      <div id="logo1">
        <img src={logo} alt="Smart Homes Logo" style={{ width: '100%', height: '15%' }} />
      </div>
      <div className="left-buttons">
        {usertype === 'manager' ? (
          <>
            ...
            <Link to="/Tools" style={buttonStyle}>Tools</Link>
            <Link to="/store" style={buttonStyle}>Store Locator</Link>
            <Link to="/Dashboard" style={buttonStyle}>Dashboard</Link>
            {/* <Link to="/trending" style={buttonStyle}>Trending</Link>
            <Link to="/DataVisualization" style={buttonStyle}>Data Visualization</Link>
            <Link to="/DataAnalytics" style={buttonStyle}>Data Analytics</Link>
            <Link to="/SalesReport" style={buttonStyle}>Sales Report</Link>
            <Link to="InventoryReport" style={buttonStyle}>Inventory</Link>
            <Link to="/AddProduct" style={buttonStyle}>Add Product</Link> */}
            <Link to="/vieworder" style={buttonStyle}>View Order</Link>
          </>
        ) : usertype === 'retailer' ? (
          <>
            <Link to="/" style={buttonStyle}>Home</Link>
            <Link to="/Requests" style={buttonStyle}>Requests</Link>
            <Link to="/store" style={buttonStyle}>Store Locator</Link>
            <Link to="/AddCustomer" style={buttonStyle}>Add Customer</Link>
            <Link to="/allOrders" style={buttonStyle}>All Orders</Link>
            <Link to="/vieworder" style={buttonStyle}>View Order</Link>
          </>
        ) : (
          <>
