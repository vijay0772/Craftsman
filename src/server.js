...
const db = mysql.createConnection({
  ...
  user: 'root',
  password: 'root',
  database: 'CraftsManhub',
});

mongoose.connect('mongodb://localhost:27017/CraftsManService', { useNewUrlParser: true, useUnifiedTopology: true });
...
app.get('/api/getServices', (req, res) => {
  const query = 'SELECT * FROM Productdetails WHERE ProductType = "services"';
